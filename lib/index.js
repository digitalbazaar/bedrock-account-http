...
bedrock.events.on('bedrock-express.configure.routes', app => {
   ...
   * @param {String} path '/'
   * @param {Function} auth middleware
   * @param {Function} validator middleware
  ...
  app.post(
    ...
    asyncHandler(async function createNewAccount(req, res) {
      const account = {
        id: 'urn:uuid:' + uuid(),
   ...
   * @param {String} path '/'
   * @param {Function} auth middleware optional
   * @param {Function} validator middleware
   * @param {Function} handler
   * @description returns a boolean indicating if an account exists
   */
  app.get(
    basePath,
    optionallyAuthenticated,
    ...
    asyncHandler(async function accountExists(req, res) {
   ...
   * @param {String} path '/:account'
   * @param {Function} auth middleware optional
   * @param {Function} validator middleware
   * @param {Function} handler
   * @description gets an account by account id.
   */
  app.get(
    accountPath,
    optionallyAuthenticated,
    cors(),
    asyncHandler(async function getAccountById(req, res) {
